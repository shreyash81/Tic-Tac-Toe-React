    ...
    <div className={styles.container}>
      ...
      <div className={styles.play_card}>
        ...
        <div className={styles.play_card_buttons}>
          <button className={styles.button} id={styles.cross} ref={cross} onClick={setCross} >
            <img src="/assets/icons/cross.svg" alt="X" />
          </button>
          <button className={styles.button} id={styles.zero} ref={zero} onClick={setZero}>
            <img src="/assets/icons/zero.svg" alt="0" />
          </button>
        </div>
      </div>
      <button className={styles.new_game_cpu} onClick={checkPlayer} >New Game ( VS CPU )</button>
