  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.center_container}>
        <img
          src="/assets/icons/big_x.svg"
          ref={icon}
          className={styles.center_img}
        />
        <h2 className={styles.center_text} ref={win_text}>
          Takes The Round
        </h2>
      </div>
      <div className={styles.button_container}>
        <button className={styles.quit_btn} onClick={homeScreen}>
          Quit
        </button>
        <button className={styles.next_btn} onClick={next_Round}>
          Next Round
        </button>
      </div>
    </div>
